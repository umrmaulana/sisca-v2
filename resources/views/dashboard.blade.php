...
@section('title', 'Dashboard - SISCA')

@section('content')
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fas fa-tachometer-alt text-primary"></i> Dashboard SISCA
            </h1>
    ...
    <script>
        ...
        function loadAreasByCompanyAndType(companyId, equipmentTypeId = '') {
            ...
            if (companyId) {
                let url = `${window.location.origin}/dashboard/areas-by-company?company_id=${companyId}`;
                if (equipmentTypeId) {
