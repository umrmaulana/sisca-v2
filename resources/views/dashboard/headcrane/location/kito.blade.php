        ...
        <div class="col-md-11 mb-4">
            <div class="card">
                <div class="card-body text-center"> <!-- Mengatur card-title di tengah -->
                    <h3 class="card-title point-of-view">Mapping Headcrane Kito</h3>
                    <!-- Tambahan informasi lainnya jika perlu -->
                </div>
                <figure class="zoom mb-0 mt-0" onmousemove="zoom(event)"
                    style="background-image: url('/foto/lokasi-headcrane/headcrane kito.jpeg');">
                    <img class="img-fluid" style="max-height: 80vh;"
                        src="/foto/lokasi-headcrane/headcrane kito.jpeg" />
                </figure>
            </div>
        </div>
    </div>
