...
@section('content')
    ...
    <form action="{{ route('eyewasher.process.form') }}" method="POST" class="mb-5 col-lg-12" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="mb-3 col-md-6">
                ...
                <input type="text" name="eyewasher_number" id="eyewasher_number" placeholder="Masukkan No eyewasher"
                    class="form-control @error('eyewasher_number') is-invalid @enderror"
                    value="{{ old('eyewasher_number') }}" required autofocus>
    ...
    <div
        ...
        <a href="/dashboard/eyewasher/checksheet/all-check-sheet" class="btn-link text-primary"
