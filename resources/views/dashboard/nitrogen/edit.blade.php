...
@section('content')
    ...
    <form action="{{ route('nitrogen.update', $nitrogen->id) }}" method="POST" class="mb-5 col-lg-12" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="mb-3 col-md-6">
                ...
                <input type="text" name="no_tabung" id="no_tabung" placeholder="Masukkan No Tabung"
                    class="form-control @error('no_tabung') is-invalid @enderror" value="{{ old('no_tabung') ?? $nitrogen->no_tabung}}" readonly>
                @error('no_tabung')
