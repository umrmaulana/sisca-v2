...
@section('title', 'Check Sheet Tembin Daily')

@section('content')

<div class="container">
    <h1>Check Sheet Tembin Daily</h1>
    <hr>
    @if ($errors->any())
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <small class="form-text text-muted">Tidak retak dan terjadi deformasi (perubahan bentuk)</small>
            ...
            <div class="mb-3">
                ...
                <small class="form-text text-muted">Tidak terjadi perbedaan panjang antar chain sling</small>
