    ...
    <form action="{{ route('hydrant.process.form') }}" method="POST" class="mb-5 col-lg-12" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="mb-3 col-md-6">
                ...
                <input type="text" name="hydrant_number" id="hydrant_number" placeholder="Masukkan No Hydrant"
                    class="form-control @error('hydrant_number') is-invalid @enderror" value="{{ old('hydrant_number') }}"
                    required autofocus>
