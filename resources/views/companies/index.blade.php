                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group">
                                            @can('view', $company)
                                                <a href="{{ route('companies.show', $company) }}" class="btn btn-outline-info"
                                                    title="View Details">
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-4">
                                        <div class="text-muted">
                                            ...
                                            @can('create', App\Models\Company::class)
                                                <a href="{{ route('companies.create') }}" class="btn btn-primary btn-sm mt-2">
    ...
    @push('scripts')
        <script>
            function confirmDelete(id) {
                ...
                form.action = `${window.location.origin}/companies/${id}`;
