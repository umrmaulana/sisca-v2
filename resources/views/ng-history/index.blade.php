...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('ng-history.index') }}">
                    <div class="row g-3">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-12">
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('ng-history.index') }}" class="btn btn-outline-secondary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                @endif
                                                <a href="{{ route('checksheets.show', $history->original_inspection_id) }}"
