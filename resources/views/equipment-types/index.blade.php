...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('equipment-types.index') }}" class="row g-3">
                    <div class="col-md-5">
                    ...
                    {{-- <div class="col-md-3">
                        ...
                        <select class="form-select" id="equipment_type_filter" name="equipment_type">
                            ...
                            @foreach (\App\Models\EquipmentType::distinct()->pluck('equipment_type') as $type)
                                <option value="{{ $type }}"
    ...
    @push('scripts')
        <script>
            function confirmDelete(id) {
                ...
                form.action = `${window.location.origin}/equipment-types/${id}`;
