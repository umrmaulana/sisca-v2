        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                @can('update', $equipmentType)
                    <a href="{{ route('equipment-types.edit', $equipmentType) }}" class="btn btn-warning">
                        ...
                        <div class="card-body">
                            <div class="d-flex gap-2 flex-wrap">
                                @can('create', App\Models\EquipmentType::class)
                                    <a href="{{ route('equipment-types.create') }}" class="btn btn-success">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('equipment-types.destroy', $equipmentType) }}" method="POST"
