    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('equipment-types.show', $equipmentType) }}" class="btn btn-outline-info">
                    <i class="fas fa-eye me-2"></i>View Details
                </a>
                <a href="{{ route('equipment-types.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('equipment-types.update', $equipmentType) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('equipment-types.index') }}" class="btn btn-outline-danger">
                                    <i class="fas fa-times me-2"></i>Cancel
                                </a>
                                <a href="{{ route('equipment-types.show', $equipmentType) }}" class="btn btn-info">
                                    <i class="fas fa-eye me-2"></i>View Details
                                </a>
