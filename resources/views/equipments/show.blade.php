        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                @can('update', $equipment)
                    <a href="{{ route('equipments.edit', $equipment) }}" class="btn btn-outline-warning">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div>
                                    ...
                                    @if ($equipment->equipmentType && $equipment->equipmentType->equipment_name)
                                        <p class="text-muted small mt-1 mb-0">
                                            {{ $equipment->equipmentType->equipment_name }}</p>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div>
                                    <span
                                        class="fw-semibold">{{ $equipment->expired_date ? $equipment->expired_date->format('d M Y') : 'N/A' }}</span>
                                </div>
                            </div>
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('summary-report.index', [
                                    'company_id' => optional($equipment->location->company)->id,
                                    'equipment_type_id' => $equipment->equipment_type_id,
                                    'area_id' => optional($equipment->location->area)->id,
                                    'year' => date('Y'),
                                    'inspection_result' => 'all',
                                    'search_equipment' => $equipment->equipment_code,
                                ]) }}"
                                    class="btn btn-sm btn-outline-primary">
                                    <i class="fas fa-chart-line me-1"></i>View All Inspections
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-sm">
                                    ...
                                    <tbody>
                                        @foreach ($equipment->inspections as $inspection)
                                            <tr>
                                                <td>
                                                    <strong>{{ $inspection->inspection_date ? $inspection->inspection_date->format('d M Y') : $inspection->created_at->format('d M Y') }}</strong>
                                                    <br>
                                                    <small
                                                        class="text-muted">{{ $inspection->created_at->format('H:i') }}</small>
                                                </td>
                                                <td>
                                                    @if ($inspection->user)
                                                        <div>
                            ...
                            @if ($equipment->inspections->count() >= 5)
                                <div class="text-center mt-3">
                                    <small class="text-muted">Showing latest 5 inspections only. <a
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            @if ($equipment->equipmentType)
                                <a href="{{ route('equipment-types.show', $equipment->equipmentType) }}"
