    ...
    <div class="container">
        ...
        @if ($equipmentSummary->isNotEmpty())
            <div class="legend">
                ...
                <span class="legend-item"><span class="month-cell month-ok">OK</span> = Approved - No Issues</span>
                <span class="legend-item"><span class="month-cell month-ng">NG</span> = Approved - Has Issues</span>
        ...
        <div class="footer">
            <div class="footer-left">
                <div class="text-bold">SISCA - Safety Inspection System for Check Activity</div>
