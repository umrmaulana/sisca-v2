                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group">
                                            @can('view', $area)
                                                <a href="{{ route('areas.show', $area) }}" class="btn btn-outline-info"
                                                    title="View Details">
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-4">
                                        <div class="text-muted">
                                            ...
                                            @can('create', App\Models\Area::class)
                                                <a href="{{ route('areas.create') }}" class="btn btn-primary btn-sm mt-2">
    ...
    @push('scripts')
        <script>
            function confirmDelete(id) {
                ...
                form.action = `${window.location.origin}/areas/${id}`;
