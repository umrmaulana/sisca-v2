...
@section('content')
    <div class="container-fluid">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <form action="{{ route('checksheets.index') }}" method="GET">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('checksheets.index') }}" class="row g-3">
                    @if (request('code'))
            ...
            <div class="col-12">
                <div class="card shadow">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <a href="{{ route('checksheets.history') }}" class="text-white btn btn-lg btn-info">
                                    ...
                                    <tbody>
                                        @foreach ($recentInspections as $inspection)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('checksheets.show', $inspection->id) }}"
                                                        class="btn btn-sm btn-outline-primary" title="View Details">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    @if ($hasNgItems)
                                                        <a href="{{ route('checksheets.index', ['code' => $inspection->equipment->equipment_code]) }}"
            ...
            if (companySelect && areaSelect) {
                companySelect.addEventListener('change', function() {
                    ...
                    if (companyId) {
                        ...
                        fetch(
                                `${window.location.origin}/checksheets/areas-by-company?company_id=${companyId}`
                            )
