        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('checksheets.index') }}">Checksheet</a>
                    </li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            @if ($ngCount > 0)
                                                <a href="{{ route('checksheets.create') }}?code={{ $inspection->equipment->equipment_code }}"
...
@push('scripts')
    <script>
        function showInspectionModal(inspectionId) {
            ...
            viewFullLink.href = `/checksheets/show/${inspectionId}`;
    ...
    `;
        ...
        if (companySelect && areaSelect) {
            companySelect.addEventListener('change', function() {
                ...
                if (companyId) {
                    ...
                    fetch(`${window.location.origin}/checksheets/areas-by-company?company_id=${companyId}`)
                        .then(response => response.json())
                        .then(data => {
        ...
        window.showApprovalModal = function(inspectionId) {
            ...
            form.action = `/checksheets/approve/${inspectionId}`;
            modal.show();
        }
    </script>
@endpush
