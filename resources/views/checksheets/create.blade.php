    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('checksheets.index') }}">Checksheet</a></li>
            ...
            <div class="alert alert-warning mb-4">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-end">
                        <a href="{{ route('checksheets.show', $previousInspection->id) }}"
        ...
        <div class="row mb-4">
            ...
            @if (!$periodRestriction || $periodRestriction['can_inspect'])
                <!-- Checksheet Form -->
                <form action="{{ route('checksheets.store') }}" method="POST" enctype="multipart/form-data"
                    id="checksheetForm">
                    @csrf
                                    ...
                                    <div class="form-group mt-4 text-center">
                                        ...
                                        @if ($isRecheck && $previousInspection)
                                            <button type="button" class="btn btn-outline-info me-2"
                                                onclick="window.open('{{ route('checksheets.show', $previousInspection->id) }}', '_blank')">
