    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('checksheet-templates.show', $checksheetTemplate) }}" class="btn btn-info">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('checksheet-templates.update', $checksheetTemplate) }}" method="POST"
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('checksheet-templates.show', $checksheetTemplate) }}"
