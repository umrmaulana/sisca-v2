...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('sisca-v2.companies.store') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('company_description') is-invalid @enderror" id="company_description"
                                    name="company_description" rows="3" placeholder="Enter company description...">{{ old('company_description') }}</textarea>
