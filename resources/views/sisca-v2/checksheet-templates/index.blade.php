    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            @can('create', App\Models\SiscaV2\ChecksheetTemplate::class)
                <a href="{{ route('sisca-v2.checksheet-templates.create') }}" class="btn btn-primary">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('sisca-v2.checksheet-templates.index') }}" class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="{{ route('sisca-v2.checksheet-templates.index') }}" class="btn btn-outline-danger">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group">
                                            @can('view', $template)
                                                <a href="{{ route('sisca-v2.checksheet-templates.show', $template) }}"
                                            ...
                                            @can('update', $template)
                                                <a href="{{ route('sisca-v2.checksheet-templates.edit', $template) }}"
                                ...
                                <tr>
                                    <td colspan="9" class="text-center py-4">
                                        <div class="text-muted">
                                            ...
                                            @can('create', App\Models\SiscaV2\ChecksheetTemplate::class)
                                                <a href="{{ route('sisca-v2.checksheet-templates.create') }}"
