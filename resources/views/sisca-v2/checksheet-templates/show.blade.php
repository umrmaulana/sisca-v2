        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                @can('update', $checksheetTemplate)
                    <a href="{{ route('sisca-v2.checksheet-templates.edit', $checksheetTemplate) }}" class="btn btn-warning">
                        <i class="fas fa-edit me-2"></i>Edit
                    </a>
                @endcan
                <a href="{{ route('sisca-v2.checksheet-templates.index') }}" class="btn btn-outline-secondary">
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex gap-2 flex-wrap">
                                @can('create', App\Models\SiscaV2\ChecksheetTemplate::class)
                                    <a href="{{ route('sisca-v2.checksheet-templates.create') }}" class="btn btn-success">
                                        <i class="fas fa-plus me-2"></i>Create New Template
                                    </a>
                                @endcan

                                @can('update', $checksheetTemplate)
                                    <a href="{{ route('sisca-v2.checksheet-templates.edit', $checksheetTemplate) }}"
                ...
                @if ($checksheetTemplate->equipmentType)
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                <a href="{{ route('sisca-v2.equipment-types.show', $checksheetTemplate->equipmentType) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('sisca-v2.checksheet-templates.destroy', $checksheetTemplate) }}"
