...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="text-primary mb-1">Create New Plant</h3>
                <p class="text-muted mb-0">Add a new plant to the system</p>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('sisca-v2.plants.store') }}">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                @enderror
                                <div class="form-text">The name of the plant (e.g., Plant 1, Main Plant)
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    ...
                                    @error('is_active')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <div class="form-text">Toggle to activate or deactivate this plant</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-2"></i>Create Plant
                                </button>
                            </div>
                        </div>
                    </div>
