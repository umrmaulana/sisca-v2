...
@section('title', 'Create Period Check')
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="text-primary mb-1">Create New Period Check</h3>
                <p class="text-muted mb-0">Add a new period check to the system</p>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('sisca-v2.period-checks.store') }}">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('period_check') is-invalid @enderror"
                                    id="period_check" name="period_check" value="{{ old('period_check') }}"
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-2"></i>Create Period Check
                                </button>
                            </div>
                        </div>
                    </div>
