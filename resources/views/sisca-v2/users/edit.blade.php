...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('sisca-v2.users.index') }}" class="btn btn-outline-secondary">
            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('sisca-v2.users.update', $user) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="alert alert-info">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-6">
                                        <small class="text-muted">Current Plant:</small><br>
                                        <strong>{{ $user->plant ? $user->plant->plant_name : 'No plant assigned' }}</strong>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            ...
            function resetUserPassword() {
                if (confirm('Are you sure you want to reset this user\'s password? A temporary password will be generated.')) {
                    ...
                    form.method = 'POST';
                    form.action = `${window.location.origin}/sisca-v2.users.reset-password/${$user->id}`;
