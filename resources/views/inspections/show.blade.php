                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div>
                                    <span class="badge bg-secondary">{{ $inspection->equipment->equipment_code }}</span>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    @if (
                                        $inspection->equipment->location &&
                                            ...
                                            $inspection->equipment->location->area->company)
                                    @endif
                                </div>
                            </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid">
                            <a href="{{ route('equipments.show', $inspection->equipment->id) }}"
                ...
                <!-- Actions -->
                @if (in_array(auth()->user()->role, ['Supervisor', 'Management', 'Admin']) && $inspection->status === 'pending')
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">
