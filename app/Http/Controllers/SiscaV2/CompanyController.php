...
class CompanyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('sisca-v2.companies.index', compact('companies'));
    }

    public function create()
    {
        return view('sisca-v2.companies.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('sisca-v2.companies.index')
    ...
    public function show(Company $company)
    {
        ...
        return view('sisca-v2.companies.show', compact('company'));
    }

    public function edit(Company $company)
    {
        return view('sisca-v2.companies.edit', compact('company'));
    }
