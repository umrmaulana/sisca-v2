...
class P3kMasterController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('sisca-v2.p3k.master.index', [
            'type' => $type,
            'stocks' => $stocks,
            'locations' => $locations,
        ]);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('sisca-v2.p3k.master.store', ['type' => $type])->with('success', 'Data added successfully');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('sisca-v2.p3k.master.index', ['type' => $type])->with('success', 'Data updated successfully');
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        return redirect()->route('sisca-v2.p3k.master.index', ['type' => $type])->with('success', 'Data deleted successfully');
    }
}
