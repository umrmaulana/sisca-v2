...
class ChecksheetTemplateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('checksheet-templates.index', compact('checksheetTemplates', 'equipmentTypes'));
    }
    ...
    public function create()
    {
        ...
        return view('checksheet-templates.create', compact('equipmentTypes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('standar_picture')) {
                ...
                $path = $file->storeAs('templates/checksheet', $filename, 'public');
            ...
            return redirect()->route('checksheet-templates.show', $checksheetTemplate)
    ...
    public function show(ChecksheetTemplate $checksheetTemplate)
    {
        ...
        return view('checksheet-templates.show', compact('checksheetTemplate'));
    }
    ...
    public function edit(ChecksheetTemplate $checksheetTemplate)
    {
        ...
        return view('checksheet-templates.edit', compact('checksheetTemplate', 'equipmentTypes'));
    }
    ...
    public function destroy(ChecksheetTemplate $checksheetTemplate)
    {
        ...
        try {
            ...
            return redirect()->route('checksheet-templates.index')
